...
def _write_tools(path: Path, settings: ToolSettings) -> Path | None:
    ...
    lines = [
        ...
        f"daemon_socket = {_toml_string(antivirus.daemon_socket)}",
        f"require_daemon_for_index = {'true' if antivirus.require_daemon_for_index else 'false'}",
        ...
        f"signature_max_age_seconds = {antivirus.signature_max_age_seconds}",
