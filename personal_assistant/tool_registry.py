...
def build_tool_registry(settings: ToolSettings) -> list[AgentTool]:
    tools = [
        ...
        AgentTool(
            "portfolio.status",
            "Depotbestand, Watchlist, Kursabdeckung und Datenfrische anzeigen",
        ...
        AgentTool(
            "portfolio.doctor",
            "Portfolio-Datenbank, Anbieter-Konfiguration und Pflichtkurse pruefen",
            './scripts/assistant.sh portfolio doctor',
            "read",
        ),
        AgentTool(
            "portfolio.import.pp",
            "ClamAV-gepruefte Portfolio-Performance-XML zuerst als Vorschau importieren",
            './scripts/assistant.sh portfolio import-pp --file "<Datei-im-Importordner>" --dry-run',
            "local-write",
            False,
            "explicit-user-import-with-preview",
        ),
        AgentTool(
            "portfolio.import.pp.confirm",
            "Zuvor geprueften Portfolio-Snapshot nach ausdruecklichem Nutzerauftrag lokal importieren",
            './scripts/assistant.sh portfolio import-pp --file "<Datei-im-Importordner>" --yes',
            "local-write",
            False,
        ...
        AgentTool(
            ...
            "ClamAV-geprueften DKB-CSV-Depotsnapshot aus dem kontrollierten Importordner zuerst als Vorschau einlesen",
            './scripts/assistant.sh portfolio import-csv --file "<Datei-im-Importordner>" --dry-run',
            "local-write",
            False,
            "explicit-user-import-with-preview",
        ),
        AgentTool(
            ...
            "Exakt ausgewaehlte datierte DKB-CSV aus dem konfigurierten Nextcloud-Portfolioordner herunterladen, scannen und als Vorschau einlesen",
        ...
        AgentTool(
            ...
            "Zuvor geprueften lokalen DKB-CSV-Depotsnapshot nach ausdruecklichem Nutzerauftrag importieren",
            './scripts/assistant.sh portfolio import-csv --file "<Datei-im-Importordner>" --yes',
            "local-write",
            False,
            "explicit-user-confirmed-import",
        ),
        AgentTool(
            ...
            "Zuvor geprueften DKB-CSV-Depotsnapshot aus dem exakten Nextcloud-Pfad nach ausdruecklichem Nutzerauftrag importieren",
        ...
        AgentTool(
            "portfolio.holdings",
            "Letzten unveraenderlich gespeicherten Depot-Snapshot anzeigen",
        ...
        AgentTool(
            ...
            "Wertpapier mit explizit bestaetigter Boersenplatz-Zuordnung aufnehmen",
            './scripts/assistant.sh portfolio watchlist add --isin "<ISIN>" --name "<Name>" --symbol "<Symbol>" --mic "<MIC>" --currency "<ISO>" --yes',
            "local-write",
            False,
            "explicit-user-watchlist-change",
        ),
        AgentTool(
            "portfolio.watchlist.disable",
            "Watchlist-Eintrag nach Nutzerauftrag deaktivieren, ohne Historie zu loeschen",
        ...
        AgentTool(
            ...
            "Kursabruf fuer eine gezielte Diagnose vor dem naechsten Faelligkeitszeitpunkt erzwingen",
            './scripts/assistant.sh portfolio quotes refresh --force',
            "local-write",
            False,
            "explicit-user-diagnostic-refresh",
        ),
        AgentTool(
            "portfolio.analyze",
            "Gespeicherte Kursreihe mit deterministischen Trendindikatoren analysieren",
            './scripts/assistant.sh portfolio analyze --isin "<ISIN>"',
            "read",
        ),
        AgentTool(
            "portfolio.alerts",
            "Kursmarken und deduplizierte Uebertrittsereignisse anzeigen",
            './scripts/assistant.sh portfolio alerts list',
            "read",
        ),
        AgentTool(
            "portfolio.alerts.add",
            "Kursmarke mit Hysterese und Abklingzeit nach Nutzerauftrag anlegen",
            './scripts/assistant.sh portfolio alerts add --isin "<ISIN>" --direction "<above|below>" --threshold "<Kurs>" --currency "<ISO>" --yes',
            "local-write",
            False,
            "explicit-user-alert-change",
        ),
        AgentTool(
            "portfolio.alerts.disable",
            "Kursalarm nach Nutzerauftrag deaktivieren, ohne Ereignishistorie zu loeschen",
        ...
        AgentTool(
            ...
            "Signalqualitaet getrennt von der technischen Agentengesundheit auswerten",
            './scripts/assistant.sh portfolio performance',
            "read",
        ),
        AgentTool(
            "portfolio.job.on",
            "Optionalen Portfolio-Kursjob nach ausdruecklichem Nutzerauftrag einschalten",
        ...
        AgentTool(
            ...
            "Portfolio-Kursjob nach ausdruecklichem Nutzerauftrag neu starten",
        ...
        AgentTool(
            "portfolio.job.off",
            "Portfolio-Kursjob nach ausdruecklichem Nutzerauftrag ausschalten",
