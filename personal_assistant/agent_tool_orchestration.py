        ...
        for kind, native_name in names.items():
            ...
            if domain == "mail" and kind == "read":
                domain_guidance = (
                    ...
                    "Inhaltssuche mail.search mit dem vollstaendigen Suchtext in arguments.query; "
                    "die Suche normalisiert eng definierte Fuellwoerter selbst. mail.read erst nach einem "
