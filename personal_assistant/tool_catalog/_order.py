...
TOOL_ORDER: tuple[str, ...] = (
    ...
    "assistant.resources.status",
    "assistant.resources.calendar-migration-preview",
    "assistant.resources.calendar-migration-apply",
    "assistant.resources.calendar-migration-rollback",
    ...
    "mail.index.capabilities",
    "mail.index.status",
    "mail.index.doctor",
    "mail.index.plan",
    "mail.index.blocked",
    "mail.index.quarantine",
    "mail.index.shadow",
    "mail.index.canary",
    "mail.index.backfill",
    "mail.index.rebuild",
