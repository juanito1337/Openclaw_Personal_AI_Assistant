...
| Mailindex -> aktueller IMAP-Locator | Snapshot, alte UID/Ordner und mehrdeutige Kopien | komplette/frische Generation, Live-Pruefung von Ordner+Mailbox-ID+Betreff, eindeutige Neuaufloesung oder Server-Fallback | konkret ausgewaehlter read-only Locator ohne Aktionsautoritaet |
