...
| `assistant.resources.status` | `read` | nein | `none` | `always` | `./scripts/assistant.sh resources status` | `docs/RESOURCE_IDENTITY_M16.md` | `tests/test_resource_identity_m164.py` |
| `assistant.resources.calendar-migration-preview` | `read` | nein | `none` | `always` | `./scripts/assistant.sh resources calendar-migration --dry-run` | `docs/RESOURCE_IDENTITY_M16.md` | `tests/test_resource_identity_m164.py` |
| `assistant.resources.calendar-migration-apply` | `local-write` | nein | `explicit-user-calendar-resource-identity-migration` | `always` | `./scripts/assistant.sh resources calendar-migration --yes --expected-preview-sha256 "<Digest>"` | `docs/RESOURCE_IDENTITY_M16.md` | `tests/test_resource_identity_m164.py` |
| `assistant.resources.calendar-migration-rollback` | `local-write` | nein | `explicit-user-calendar-resource-identity-migration-rollback` | `always` | `./scripts/assistant.sh resources calendar-migration --rollback "<tools.toml.backup>" --yes` | `docs/RESOURCE_IDENTITY_M16.md` | `tests/test_resource_identity_m164.py` |
...
| `mail.index.capabilities` | `read` | nein | `none` | `always` | `./scripts/assistant.sh mail index capabilities --no-raw-probe` | `skills/personal-assistant/references/mail.md` | `tests/test_imap_inventory_m120.py` |
...
| `mail.index.blocked` | `read` | nein | `none` | `always` | `./scripts/assistant.sh mail index blocked --limit 100` | `skills/personal-assistant/references/mail.md` | `tests/test_mail_index_quarantine_m14.py` |
| `mail.index.quarantine` | `write` | ja | `explicit-user-single-infected-mail-quarantine` | `mail-move` | `./scripts/assistant.sh mail index quarantine --candidate-id "<Kandidaten-ID>" --expected-source "<Quelle>" --expected-message-id "<Mail-ID>" --expected-sha256 "<SHA-256>" --yes` | `skills/personal-assistant/references/mail.md` | `tests/test_mail_index_quarantine_m14.py` |
| `mail.index.shadow` | `read` | nein | `none` | `always` | `./scripts/assistant.sh mail index shadow --query "<Suchbegriff>" --limit 50` | `skills/personal-assistant/references/mail.md` | `tests/test_mail_hybrid_search_m117.py` |
| `mail.index.canary` | `local-write` | nein | `explicit-user-local-mail-index-canary` | `always` | `./scripts/assistant.sh mail index canary --folder "<exakter Ordner>" --page-size 20 --max-pages 5 --max-messages 100 --max-bytes 100000000 --max-message-bytes 25000000 --max-runtime 600 --request-interval 0.2 --yes` | `skills/personal-assistant/references/mail.md` | `tests/test_mail_search_backfill_m112.py` |
...
| `mail.index.rebuild` | `local-write` | nein | `explicit-user-local-mail-index-rebuild` | `always` | `./scripts/assistant.sh mail index backfill --restart --page-size 50 --max-pages 200 --max-messages 10000 --max-bytes 1000000000 --max-message-bytes 100000000 --max-runtime 3600 --request-interval 0.2 --yes` | `skills/personal-assistant/references/mail.md` | `tests/test_mail_index_quarantine_m14.py` |
...
| `mail.recent` | `read` | nein | `none` | `mail-move` | `./scripts/assistant.sh mail recent --limit 20` | `skills/personal-assistant/references/mail.md` | `tests/test_mail_recent.py` |
...
| `nextcloud.calendar.from-mail-preview` | `read` | nein | `none` | `calendar-from-mail` | `./scripts/assistant.sh calendar from-mail --folder "<Ordner>" --message-id "<Mail-ID>" --expected-subject "<Betreff>" --dry-run` | `docs/DIRECT_CALENDAR.md` | `tests/test_action_completion_m15.py` |
| `nextcloud.calendar.from-mail-create` | `write` | ja | `explicit-user-calendar-from-mail-create-only` | `calendar-from-mail` | `./scripts/assistant.sh calendar from-mail --folder "<Ordner>" --message-id "<Mail-ID>" --expected-subject "<Betreff>" --preview-digest "<preview_digest>" --candidate-id "<candidate_id>" --yes` | `docs/DIRECT_CALENDAR.md` | `tests/test_action_completion_m15.py` |
...
| `assistant.invoices.files` | `read` | nein | `none` | `invoices` | `./scripts/assistant.sh invoices files --limit 100` | `docs/INVOICE_OCR_REGISTER.md` | `tests/test_nextcloud_workspace_tools.py` |
