...
class ReleaseAwarenessTests(unittest.TestCase):
    def test_registered_cli_reports_product_release_not_embedded_core_version(self) -> None:
        ...
        self.assertEqual(report["version"], "3.4.0-r29.0.2")
    ...
    def test_installed_package_manifest_is_consistent(self) -> None:
        ...
        self.assertTrue(report["ok"], report)
        self.assertEqual(report["version"], "3.4.0-r29.0.2")
        self.assertEqual(report["history"][0]["version"], "3.4.0-r29.0.2")
    ...
    def test_history_since_r18_lists_only_newer_releases(self) -> None:
        ...
        self.assertEqual(versions[0], "3.4.0-r29.0.2")
        self.assertEqual(versions[1], "3.4.0-r29.0.1")
        self.assertEqual(versions[2], "3.4.0-r29")
        self.assertEqual(versions[3], "3.4.0-r28")
        self.assertEqual(versions[-1], "3.4.0-r23.3")
