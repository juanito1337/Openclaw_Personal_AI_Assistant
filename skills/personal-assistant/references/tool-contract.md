...
Release: `3.4.0-r29.0.1`. Quelle: typisierte Tooldefinitionen unter
...
| `mail.index.capabilities` | `read` | nein | `none` | `always` | `./scripts/assistant.sh mail index capabilities --no-raw-probe` | `tests/test_imap_inventory_m120.py` |
...
| `mail.index.blocked` | `read` | nein | `none` | `always` | `./scripts/assistant.sh mail index blocked --limit 100` | `tests/test_mail_index_quarantine_m14.py` |
| `mail.index.quarantine` | `write` | ja | `explicit-user-single-infected-mail-quarantine` | `mail-move` | `./scripts/assistant.sh mail index quarantine --candidate-id "<Kandidaten-ID>" --expected-source "<Quelle>" --expected-message-id "<Mail-ID>" --expected-sha256 "<SHA-256>" --yes` | `tests/test_mail_index_quarantine_m14.py` |
| `mail.index.shadow` | `read` | nein | `none` | `always` | `./scripts/assistant.sh mail index shadow --query "<Suchbegriff>" --limit 50` | `tests/test_mail_hybrid_search_m117.py` |
| `mail.index.canary` | `local-write` | nein | `explicit-user-local-mail-index-canary` | `always` | `./scripts/assistant.sh mail index canary --folder "<exakter Ordner>" --page-size 20 --max-pages 5 --max-messages 100 --max-bytes 100000000 --max-message-bytes 25000000 --max-runtime 600 --request-interval 0.2 --yes` | `tests/test_mail_search_backfill_m112.py` |
...
| `mail.index.rebuild` | `local-write` | nein | `explicit-user-local-mail-index-rebuild` | `always` | `./scripts/assistant.sh mail index backfill --restart --page-size 50 --max-pages 200 --max-messages 10000 --max-bytes 1000000000 --max-message-bytes 100000000 --max-runtime 3600 --request-interval 0.2 --yes` | `tests/test_mail_index_quarantine_m14.py` |
...
| `mail.search.local` | `read` | nein | `none` | `always` | `./scripts/assistant.sh mail search-local --query "<Suchbegriff>" --limit 50` | `tests/test_mail_search_lexical_m114.py` |
...
| `nextcloud.calendar.from-mail-preview` | `read` | nein | `none` | `calendar-from-mail` | `./scripts/assistant.sh calendar from-mail --folder "<Ordner>" --message-id "<Mail-ID>" --expected-subject "<Betreff>" --dry-run` | `tests/test_action_completion_m15.py` |
| `nextcloud.calendar.from-mail-create` | `write` | ja | `explicit-user-calendar-from-mail-create-only` | `calendar-from-mail` | `./scripts/assistant.sh calendar from-mail --folder "<Ordner>" --message-id "<Mail-ID>" --expected-subject "<Betreff>" --preview-digest "<preview_digest>" --candidate-id "<candidate_id>" --yes` | `tests/test_action_completion_m15.py` |
...
| `assistant.invoices.reprocess-preview` | `read` | nein | `none` | `invoices` | `./scripts/assistant.sh invoices reprocess --status "<review\|unclassified>" --source-year <YYYY> --limit 100 --dry-run` | `tests/test_invoice_reprocess_preview_m105.py` |
| `assistant.invoices.reprocess-apply` | `write` | ja | `explicit-user-single-invoice-reprocess` | `invoices` | `./scripts/assistant.sh invoices reprocess-apply --hash "<SHA256>" --expected-preview-sha256 "<Digest>" --yes` | `tests/test_invoice_reprocess_apply_m106.py` |
