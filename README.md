# OpenClaw Personal Assistant 3.4.0-r28
...
| Thema | Einstieg |
| --- | --- |
| Aktuelles kumulatives Update, Upgrade und Abnahme | [Release 3.4.0-r28](docs/RELEASE_3_4_0_R28.md) |
...
| Bei jedem Start direkt verfuegbare normale Funktionen | [Standard-Betriebsprofil](docs/STANDARD_OPERATIONS.md) |
...
| Verlaessliche Werkzeugsteuerung und belegte Agentenantworten | [M13-Roadmap](docs/AGENT_TOOL_ORCHESTRATION_ROADMAP.md), [M13.0-Baseline](docs/AGENT_TOOL_USE_BASELINE_M130.md) und [M13-Abnahme/Rolloutgrenze](docs/AGENT_TOOL_ORCHESTRATION_M13_ACCEPTANCE.md) |
| Residenter Virenscanner und produktionsreifer Mailindexpfad | [M14-Roadmap](docs/MAIL_ANTIVIRUS_INDEX_ROLLOUT_ROADMAP.md), [M14.0-Baseline](docs/MAIL_ANTIVIRUS_INDEX_BASELINE_M140.md) und [M14-Entwicklungsabnahme](docs/MAIL_ANTIVIRUS_INDEX_M14_ACCEPTANCE.md) |
| Verbindliche Aktionsausfuehrung und belegter Workflowabschluss | [M15-Roadmap](docs/AGENT_ACTION_COMPLETION_ROADMAP.md), [M15.0-Baseline](docs/AGENT_ACTION_COMPLETION_BASELINE_M150.md), [ADR 0039](docs/architecture/adr/0039-turngebundene-aktionsverpflichtung.md) und [M15-Abnahme/Rolloutgrenze](docs/AGENT_ACTION_COMPLETION_M15_ACCEPTANCE.md) |
| Betriebsstabilitaet, Leistung und Releasekonsolidierung | [M16-Roadmap](docs/AGENT_STABILIZATION_ROADMAP.md), [M16.0-Baseline](docs/M16_BASELINE.md), [Releaseumfang](docs/M16_RELEASE_SCOPE.md), [Lauf-/Telemetrievertrag](docs/RUNTIME_TELEMETRY_M16.md), [inkrementeller Sync/Scheduler](docs/INCREMENTAL_SYNC_SCHEDULER_M16.md), [Ressourcenidentitaet](docs/RESOURCE_IDENTITY_M16.md), [Runtimekapazitaet/Latenz](docs/RUNTIME_CAPACITY_M16.md), [Test-/Codekonsolidierung](docs/QUALITY_CONSOLIDATION_M16.md), [Mail-Lern-/Reviewqualitaet](docs/MAIL_LEARNING_QUALITY_M167.md), [Rechnungs-/Portfolio-Restbestaende](docs/DOMAIN_QUALITY_M168.md), [Semantic-/Executor-Entscheidung](docs/ARCHITECTURE_PROTOTYPES_M169.md), [M16.10-Abnahme](docs/M16_ACCEPTANCE.md) und [maschinenlesbares Risikoregister](docs/architecture/m16-risk-register.json) |
