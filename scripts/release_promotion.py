...
def verify_draft(contract: dict[str, Any]) -> dict[str, Any]:
    ...
    _require(candidate.get("planned_version") == "3.4.0-r29", "Naechste Version muss festgelegt sein")
    _require(candidate.get("planned_release") == "r29", "Naechstes Release muss festgelegt sein")
